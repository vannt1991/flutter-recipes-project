...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'de', 'en', 'es', 'hi', 'vi'].contains(locale.languageCode);
...
Future<AppLocalizations> lookupAppLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'hi': return app_localizations_hi.loadLibrary().then((dynamic _) => app_localizations_hi.AppLocalizationsHi());
